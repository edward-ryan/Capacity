      ...
      <div className="w-[340px] bg-panel border-r border-border flex flex-col shadow-2xl z-10 shrink-0">
        <div className="px-5 pt-7 pb-5 border-b border-border">
          <div className="flex justify-between items-start">
            ...
            <button onClick={() => setIsDarkMode(!isDarkMode)} className="text-text-muted hover:text-white transition-colors">
              {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
            </button>
          </div>
          <p className="font-mono text-[10px] text-white tracking-widest mt-[50px]">PATTERN GENERATOR</p>
        </div>
